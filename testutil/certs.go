// Package testutil provides test helpers shared across cortex-mcp packages.
...
func GenerateTestCerts(t testing.TB) (serverCfg *membrane.Config, clientCfg *membrane.Config) {
	t.Helper()
...
func GenerateTestCertsWithIDs(t testing.TB, serverID, clientID string) (serverCfg *membrane.Config, clientCfg *membrane.Config) {
	t.Helper()
...
func GenerateDualCert(t testing.TB, ca *x509.Certificate, caKey ed25519.PrivateKey, pool *x509.CertPool, nodeID string) *membrane.Config {
	t.Helper()
...
func GenerateTestCA(t testing.TB) (ca *x509.Certificate, caKey ed25519.PrivateKey, pool *x509.CertPool) {
	t.Helper()
...
func generateCA(t testing.TB) (*x509.Certificate, ed25519.PrivateKey) {
	t.Helper()
...
func generateNodeCert(t testing.TB, ca *x509.Certificate, caKey ed25519.PrivateKey, nodeID string, isServer bool) tls.Certificate {
	t.Helper()
...
func generateDualNodeCert(t testing.TB, ca *x509.Certificate, caKey ed25519.PrivateKey, nodeID string) tls.Certificate {
	t.Helper()
